...
class RedBlackTree():
    ...
    def is_red(self, my_node):
        ...
        return my_node != None and my_node.color == RedBlackTree.RED_COLOR
    ...
    def insert(self, data):
        ...
        if self.root:
            ...
            node = Node(data)
        self.root = node
        self.root.color = RedBlackTree.BLACK_COLOR
        return True
    ...
    def balanced(self, my_node):
        ...
        if self.is_red(my_node.left) and self.is_red(my_node.right):
            my_node.color = RedBlackTree.RED_COLOR
            my_node.left.color = RedBlackTree.BLACK_COLOR
            my_node.right.color = RedBlackTree.BLACK_COLOR
        return my_node
